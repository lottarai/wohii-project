    ...
    if (questions.length === 0) {
      ...
      html += questions
        ...
        <article class="question-card ${q[CONFIG.API_FIELDS.SOLVED] ? "solved-card" : ""}">
          <h3>
            <a href="#" class="question-link" data-id="${q.id}">${q.questionTitle}</a>
  ...
  try {
    ...
    container.innerHTML = `
      ...
      <article class="question-card question-detail">
        <h3>${q.questionTitle} ${q[CONFIG.API_FIELDS.SOLVED] ? `<span class="badge-solved">Solved</span>` : ""}</h3>
...
async function showQuestionForm(qId) {
    ...
    <div class="question-form-wrapper">
      ...
      <form id="question-form" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <input type="text" id="q-question" value="${q.questionTitle}" required />
        </div>
        <div class="form-group">
  ...
  document.getElementById("question-form").addEventListener("submit", async (e) => {
    ...
    body.append("questionTitle", document.getElementById("q-question").value);
  ...
  try {
    ...
    container.innerHTML = `
      ...
      <div class="question-form-wrapper" style="text-align:center">
        <div class="play-question-text">${q.questionTitle}</div>
